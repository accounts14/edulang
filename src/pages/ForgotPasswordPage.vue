<template>
          ...
          <div class="auth-right flex flex-center column q-pa-xl">
            ...
            <div class="auth-form-wrap">
              <div class="column items-center q-mb-lg">
                ...
                <h1 class="text-h4 text-weight-bolder q-ma-none text-dark text-center">Forgot Password</h1>
                <p class="text-grey-7 text-center q-mt-sm">Masukkan email Anda untuk menerima token reset password</p>
              </div>
  ...
  .auth-page-full { min-height: 100vh; }
  .auth-left { flex: 1; min-height: 100vh; }
  .auth-right { flex: 1; min-height: 100vh; background: #f5f7fa; position: relative; }
  .auth-back-btn { position: absolute; top: 16px; left: 16px; color: #2d2d2d !important; }
  .auth-form-wrap { width: 100%; max-width: 420px; }
  .auth-logo-circle { width: 80px; height: 80px; border-radius: 50%; background: #003387; display: flex; align-items: center; justify-content: center; padding: 16px; }
  .auth-logo-img { width: 100%; height: 100%; object-fit: contain; }
  .auth-primary-btn { background: #003387 !important; color: white !important; border-radius: 12px; }
  .auth-link { color: #0089ff !important; text-decoration: underline; }
  :deep(.auth-input .q-field--filled .q-field__control) { background: #eef0f3 !important; border-radius: 12px; }
  </style>